...
5. visual/audio spot-check at minimum 5 points:
   ...
   - final CTA
6. cut contact sheet around every content cut shows no ghost/double-mouth frame
7. if any check is uncertain, create a short sync review clip around the suspect timestamp
```
