# Template 02 — Post-Process Subagent Slot Defaults

Fill these into [`templates/_shared/docs/SUBAGENT_PROMPTS.md`](../../_shared/docs/SUBAGENT_PROMPTS.md) Section B.

The caption post-process is identical to Template 01 — same particle-burst
...
Caption position note:
  ...
  chest area — fine. The build script's SUB_TEMPLATE is shared with Template 01.
```
