# Template 11 — Stacked Vertical with Weight-Shift Captions
...
(none yet — the first job built on Template 11 becomes the reference.)
...
README.md        this file
frame.md        weight-shift caption / stacked layout / colors / motion
