# Template 05 — Editorial Subagent Slot Defaults

Fill these into [`templates/_shared/docs/SUBAGENT_PROMPTS.md`](../../_shared/docs/SUBAGENT_PROMPTS.md) Section A when the clip uses Template 05 and has no clip-specific overrides.

The editorial pass is layout-agnostic — these defaults match Template 01 (same stacked screen + face talking-head footage); only the caption renderer differs downstream.
