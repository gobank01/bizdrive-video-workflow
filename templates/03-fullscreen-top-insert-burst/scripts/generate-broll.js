...
const brolls = [
  {
    ...
    slot: "slot 1",
    prompt:
      "cinematic landscape 16:9 b-roll — REPLACE THIS PROMPT with slot-1 content, photorealistic, blue and gold lighting, no text, no logos, no people",
  },
  {
    output: `${OUT_DIR}/broll-02.mp4`,
    slot: "slot 2",
    prompt:
      "cinematic landscape 16:9 b-roll — REPLACE THIS PROMPT with slot-2 content, photorealistic, blue and gold lighting, no text, no logos, no people",
  },
  {
    output: `${OUT_DIR}/broll-03.mp4`,
    slot: "slot 3",
    prompt:
      "cinematic landscape 16:9 b-roll — REPLACE THIS PROMPT with slot-3 content, photorealistic, blue and gold lighting, no text, no logos, no people",
  },
  {
    output: `${OUT_DIR}/broll-04.mp4`,
    slot: "slot 4",
    prompt:
      "cinematic landscape 16:9 b-roll — REPLACE THIS PROMPT with slot-4 content, photorealistic, blue and gold lighting, no text, no logos, no people",
  },
];
