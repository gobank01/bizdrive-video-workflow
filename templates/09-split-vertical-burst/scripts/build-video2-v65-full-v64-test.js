...
const TOP_OUTPUT = "assets/video2/top_context90_v65_softcut.mp4";
const BOTTOM_OUTPUT = "assets/video2/bottom_context90_v65_audio_polished_softcut.mp4";
...
const brollSources = [
  {
    id: "broll01",
    start: 5,
    output: "assets/broll/optimized/video2-v65/broll-01.mp4",
  ...
  },
  {
    id: "broll02",
    start: 23,
    output: "assets/broll/optimized/video2-v65/broll-02.mp4",
  ...
  },
  {
    id: "broll03",
    start: 41,
    output: "assets/broll/optimized/video2-v65/broll-03.mp4",
  ...
  },
  {
    id: "broll04",
    start: 59,
    output: "assets/broll/optimized/video2-v65/broll-04.mp4",
  ...
  },
  {
    id: "broll05",
    start: 77,
    output: "assets/broll/optimized/video2-v65/broll-05.mp4",
...
function renderBrollMedia() {
  ensureDir("assets/broll/optimized/video2-v65");
...
function writeContextAndManifest() {
  ...
  const brollSlots = brollSources.map((slot, index) => {
    ...
    return {
      ...
      query: slot.query,
      usage: "reused_source_reencoded_for_video2_v65_v64_full_test",
  ...
  const context = {
    version: VERSION,
    setId: "video2-v65-v64-full-test",
    goal: "Test a full video2 edit under v64 rules: bottom-master sync lock, Whisper transcript requirement, meaning-first 1:30 ceiling, and no more than 4 B-roll inserts per minute.",
    strategy: "Use the existing Whisper transcript/audio as primary context, preserve hook/features/technology/benefit/CTA, soft cut all content cuts, and reduce B-roll density from v63 to 5 comfortable inserts.",
  ...
  fs.writeFileSync("assets/context/video2-v65-v64-full-test.json", `${JSON.stringify(context, null, 2)}\n`);

  const manifest = {
    version: VERSION,
    setId: "video2-v65-v64-full-test",
    createdFor: "stacked-output-v65-video2-v64-full-test.mp4",
    summary: {
      ...
      freshDownloadAttempted: true,
      freshDownloadStatus: process.env.PEXELS_API_KEY ? "available" : "blocked_missing_env_pexels_api_key",
      note: "v65 is a v64 full-pipeline test. Fresh Pexels sourcing was checked first, but the shell has no PEXELS_API_KEY, so local QA-passed stock was reused and re-encoded for the test.",
    },
    qaRule: "Reject any B-roll with visible text, logo, watermark, other brand, distracting graphic, or poor relevance.",
    slots: brollSlots,
    rejectedCandidates: [],
  };
  fs.writeFileSync("assets/broll/optimized/video2-v65/manifest.json", `${JSON.stringify(manifest, null, 2)}\n`);
}
