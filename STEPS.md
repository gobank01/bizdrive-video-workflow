...
สถานะล่าสุด: v47 - practical edit map 62 steps with BGM mix implementation
...
62. ถ้าเปิดใช้ BGM ให้รัน `npm run mix:bgm`, update composition พร้อม zoom motion/BGM output, run `npm run check`, render MP4, QA metadata/audio/B-roll/captions/key terms/motion/BGM, สร้าง final report และเก็บ artifacts
