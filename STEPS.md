...
สถานะล่าสุด: v48 - practical edit map 62 steps with BGM 5% voice-first policy
...
62. ถ้าเปิดใช้ BGM ให้ยืนยัน source/license ก่อน, mix ด้วย default `--gain-percent 5`, ห้ามให้เพลงกลบเสียงพูด, update composition พร้อม zoom motion/BGM output, run `npm run check`, render MP4, QA metadata/audio/B-roll/captions/key terms/motion/BGM, สร้าง final report และเก็บ artifacts
