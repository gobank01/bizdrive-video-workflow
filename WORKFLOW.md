...
สถานะล่าสุด: v64 WORKFLOW RULES - เพิ่ม sync lock, Whisper required, sequential gates, B-roll fresh-stock policy และ B-roll density cap
...
sync lock: top video, bottom audio/video, and captions must stay on the same edited timeline with no manual offset drift
...
duration: 89.354333s
frames: 2680 video frames at 30fps
...
B-roll replacement: 24s / 720 frames
transition mix: 3.76s / 113 frames
QA: pass, with only timeline_track_too_dense warning
reports: reports/frame-edit-report-v63-video2.json, reports/final-report-v63-video2.md
contact sheets: render-checks/video2-v63-final/contact-sheet.jpg, render-checks/video2-v63-final-broll/contact-sheet.jpg
```
