...
audio fix: dropped 0-2.3s false start, rebuilt from raw bottom audio with denoise/gate/loudnorm, no visible bottom-face xfade
sync proof: top and bottom share the same edited timeline; final video/audio stream start delta is 21ms container offset, no manual media retime
QA: pass, with only timeline_track_too_dense warning
reports: reports/frame-report-v71-video2.json, reports/final-report-v71-video2.md, reports/bgm-qa-v71-video2.json
contact sheets: render-checks/video2-v71-final-bgm-timestamps/v71-final-bgm-sheet.jpg, render-checks/video2-v71-final-cuts/contact-sheet.jpg, render-checks/video2-v71-final-broll/contact-sheet.jpg
```
