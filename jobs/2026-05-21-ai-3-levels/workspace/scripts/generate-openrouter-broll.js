...
const brolls = [
  {
    ...
    prompt:
      "cinematic 16:9 b-roll of three glowing ascending tiers or steps of light rising in sequence, a three-level concept, abstract premium tech, deep blue and gold color grade, no text, no people, no logos",
  },
  {
    output: "assets/intermediates/broll/broll-02.mp4",
    prompt:
      "cinematic 16:9 b-roll of an autonomous AI agent concept, glowing interlocking gears and connected task nodes lighting up a workflow, deep blue and gold color grade, no text, no people, no logos",
  },
  {
    output: "assets/intermediates/broll/broll-03.mp4",
    prompt:
      "cinematic 16:9 b-roll of a dark grid of glowing nodes rapidly lighting up in fast cascading sequence, automation speed and energy, deep blue and gold color grade, no text, no people, no logos",
  },
  {
    output: "assets/intermediates/broll/broll-04.mp4",
    prompt:
      "cinematic 16:9 b-roll of a glowing upward growth arrow with rising light particles, achievement and momentum, soft studio lighting, deep blue and gold color grade, no text, no people, no logos",
  },
];
